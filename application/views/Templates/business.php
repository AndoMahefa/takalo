      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 single-content">
            ...
            <p class="mb-5">
              <img src="<?php echo site_url("assets/images/big_img_1.jpg");?>" alt="Image" class="img-fluid">
            </p>  
            <h1 class="mb-4">
            ...
            <div class="post-meta d-flex mb-5">
              <div class="bio-pic mr-3">
                <img src="<?php echo site_url("assets/images/person_1.jpg");?>" alt="Image" class="img-fluidid">
              </div>
              <div class="vcard">
            ...
            <div class="pt-5">
                  ...
                  <div class="pt-5">
                    ...
                    <ul class="comment-list">
                      <li class="comment">
                        <div class="vcard bio">
                          <img src="<?php echo site_url("assets/images/person_1.jpg");?>" alt="Image placeholder">
                        </div>
